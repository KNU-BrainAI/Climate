...
bert_model = TFAutoModelForMaskedLM.from_pretrained('xlm-roberta-base', from_pt=True)
...
os_model_name = "XLM-RoBERTa_base-Climate2"
...
sample_submission.to_csv('XLM-RoBERTa-base-Submission.csv', index=False)