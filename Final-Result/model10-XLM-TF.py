...
from transformers import BertModel, TFAutoModel, AutoTokenizer, TFBertModel, BertTokenizer, TFAutoModelForMaskedLM
...
bert_model = TFAutoModel.from_pretrained("xlm-roberta-base", from_pt=True)
...
os_model_name = "m10-xlm-RoBERT-base-Climate"
...
sample_submission.to_csv('m10-xlm-RoBERTA-BASE-Submission.csv', index=False)