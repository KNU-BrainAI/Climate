# -*- coding: utf-8 -*-
"""
Created on Tue Aug  3 14:43:20 2021
...
train_data=train_data[['과제명', '요약문_연구내용','요약문_연구목표','요약문_한글키워드']]
...
train_data2 = train_data[['data']]

train_data2.to_csv("mecab0803_alltest.csv", encoding="utf-8-sig")
