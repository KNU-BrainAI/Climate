...
from transformers import BertModel, TFAutoModel, AutoTokenizer, TFBertModel, BertTokenizer, TFAutoModelForMaskedLM, BertForPretraining
...
#bert_model = TFAutoModel.from_pretrained("klue/bert-base", from_pt=True)
bert_model = TFBertForPretraining.from_pretrained("klue/bert-base", from_pt=True)
...
sample_submission.to_csv('KLUE-RoBERTA-LARGE-Submission.csv', index=False)
